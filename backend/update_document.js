// Update existing document with the exact structure you provided
...
async function updateExistingDocument() {
  ...
  try {
    ...
    console.log('✅ Your document now has all the enhanced features:');
    console.log('  - Multi-language signatures (JavaScript, Python, Java, C++)');
    console.log('  - Sample test cases');
    console.log('  - Hidden test cases');
    console.log('  - Examples with explanations');
    console.log('  - Constraints and complexity information');
...
updateExistingDocument().catch(console.error);